...
class Vars:
    ...
    OWNER = int(os.environ.get("OWNER", "1"))
    ADMINS = os.environ.get("ADMINS", "122 1222 1222")
    ...
    CONSTANT_DUMP_CHANNEL = os.environ.get("CONSTANT_DUMP_CHANNEL", None) #-1002755718635
    WEBS_HOST = os.environ.get("WEBS_HOST", None) # For Render and Koyeb

    DB_NAME = os.environ.get("DB_NAME", "Manhwadb") #MangaBot
    PING = time()
    ...
    FORCE_SUB_CHANNEL = os.environ.get("FORCE_SUB_CHANNEL", "") #"𝕵𝖔𝖎𝖓 𝕮𝖍𝖆𝖓𝖓𝖊𝖑: Guimi_Zhi_Zhu_Anime, 𝕸𝖆𝖎𝖓 𝕮𝖍𝖆𝖓𝖓𝖊𝖑: Wizard_Bots, 𝗖𝗼𝘀𝗽𝗹𝗮𝘆 𝗗𝗿𝗲𝗮𝗺𝘀: Cosplay_Dreams")

    BYPASS_TXT = os.environ.get("BYPASS_TXT", """<blockquote><b>ʙʏᴘᴀss ᴅᴇᴛᴇᴄᴛᴇᴅ</b></blockquote>
<blockquote>ʜᴏᴡ ᴍᴀɴʏ ᴛɪᴍᴇs ʜᴀᴠᴇ ɪ ᴛᴏʟᴅ ʏᴏᴜ, ᴅᴏɴ'ᴛ ᴛʀʏ ᴛᴏ ᴏᴜᴛsᴍᴀʀᴛ ʏᴏᴜʀ ᴅᴀᴅ 🥸🖕</blockquote>
<blockquote>ɴᴏᴡ ʙᴇ ᴀ ɢᴏᴏᴅ ʙᴏʏ ᴀɴᴅ sᴏʟᴠᴇ ɪᴛ ᴀɢᴀɪɴ, ᴀɴᴅ ᴛʜɪs ᴛɪᴍᴇ ᴅᴏɴ'ᴛ ɢᴇᴛ sᴍᴀʀᴛ !!</blockquote>""")

    ADMIN_MODE_TXT = os.environ.get("ADMIN_MODE_TXT", """<blockquote>ᴀᴅᴍɪɴ ᴍᴏᴅᴇ ɪꜱ ᴄᴜʀʀᴇɴᴛʟʏ ᴇɴᴀʙʟᴇᴅ, ꜱᴏ ʏᴏᴜ ᴀʀᴇ ᴜɴᴀʙʟᴇ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ ᴀᴛ ᴛʜᴇ ᴍᴏᴍᴇɴᴛ.</blockquote>
<blockquote>ᴛʜɪꜱ ʙᴏᴛ ɪꜱ ɪɴᴛᴇɴᴅᴇᴅ ꜰᴏʀ ᴘᴜʙʟɪᴄ ᴜꜱᴇʀ ᴀᴄᴄᴇꜱꜱ.</blockquote>
<blockquote>ᴘʟᴇᴀꜱᴇ ᴛʀʏ ᴀɢᴀɪɴ ʟᴀᴛᴇʀ.
<b>— @MangaPornhwaBot</b></blockquote>
""")
    PICS = (
